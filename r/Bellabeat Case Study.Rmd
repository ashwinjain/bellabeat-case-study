...
# res <- cor.test(daily_activity_sleep_average$averagesteps, daily_activity_sleep_average$calories, method = "pearson")
```


We can see a low correlation coefficient of only 0.32, and we fail to reject the null hypothesis.
